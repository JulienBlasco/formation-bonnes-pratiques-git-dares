...
::: {.incremental}
Le fichier `.gitignore` a pour objectif d'indiquer à Git les fichiers ou les types de fichiers dont les modifications seront à ignorer dans les futures commandes.
