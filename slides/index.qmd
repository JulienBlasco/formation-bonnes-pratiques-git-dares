...
![](img/ines.png){fig-align="center" height=400}
...
![](img/utilitr.png){fig-align="center" height=350}
...
![](img/hadley.png){fig-align="center" height=300}
...
::: {.notes}
La construction d'un historique du projet permet grandement de diminuer les risques lors de la maintenance et de la modification du code.
:::
...
- Des [**interfaces visuelles**]{.orange} (ex: `GitHub Desktop`, `RStudio`, `Sublime Merge`, `VS Code`) qui facilitent l'apprentissage
- Un petit investissement individuel pour de [**gros gains collectifs**]{.orange}
:::

## Exemples d'interfaces visuelles {auto-animate=true}

![](img/interface_github_desk.PNG){fig-align="center"}

## Exemples d'interfaces visuelles {auto-animate=true}

![](img/interface_Rstudio.PNG){fig-align="center"}

## Exemples d'interfaces visuelles {auto-animate=true}

![](img/interface_commande_prompt.PNG){fig-align="center"}


## Concepts {auto-animate=true}

`Git`, `GitHub`, `GitLab`, `GitHub Desktop` ... quelles différences ?

:::{.incremental}
- `Git` est un **logiciel** ;
- Il interprète les lignes de commandes.
- Différentes [__interfaces graphiques__]{.blue2} permettent d'interagir avec Git plus simplement en "clic-boutton" (`GitHub Desktop`, `RStudio`, `VS Code`...)
:::
...
![Source : [itnext.io](https://itnext.io/git-concepts-for-newcomers-part-2-git-repository-working-tree-and-staging-area-a2e720bf3528)](img/workflow_v2.png){height="500" width="1000"}
...
## Quelques explications avant les Applications

Travail avec Git à la Dares : les choix réalisés

:::{.incremental}
- Utilisation du GitLab de l'intranet : (https://gitlab.intranet.social.gouv.fr/)
- Favorisation de l'interface graphique Github Desktop
- Possibilité d'utiliser Rstudio comme interface graphique (cf. application annexe)
:::
...
## Application 8 - Suite {.smaller}

{{< include _application8bis.qmd >}}

## Application annexe - Git sur Rstudio {.smaller}

{{< include _application_annexe.qmd >}}
