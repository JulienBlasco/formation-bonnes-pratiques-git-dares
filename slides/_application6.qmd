...
2. Créer une branche intitulée `<votre_nom>-<votre_prénom>` depuis GitHub Desktop en cliquant sur "Current branch" puis "New branch"
...
4. Ouvrir une `Merge Request` dans GitLab pour proposer d'intégrer vos changements sur la branche principale du dépôt distant
:::
:::
